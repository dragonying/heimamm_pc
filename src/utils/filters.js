...
//日期过滤
Vue.filter('formatDateTime', value => value ? moment(value * 1000).format('YYYY-MM-DD HH:mm:ss') : '');
Vue.filter('formatDate', value => value ? moment(value * 1000).format('YYYY-MM-DD') : '');
