<template>
    <!-- 新增或编辑用户 -->
    <el-dialog title="采集新作品" :width='width' center :visible.sync="showDialog" @closed="closeHandler">
        <el-form :model="editForm" :rules="rules" ref='editForm' :label-width='labelWidth'>
            <el-form-item label="地址" prop="shareLink">
                <el-input v-model.trim="editForm.shareLink" placeholder="请输入分享信息或者网页地址"></el-input>
            </el-form-item>
        </el-form>
