<template>
    <div class='user-container'>
        <el-card class="box-card search-box">
            ...
            <el-form :inline="true" :model="spiderForm" :rules="rules" ref="spiderForm" class="spiderForm">
                <el-form-item label="搜索关键字" prop='keyword'>
                    <el-input class='middle-input' v-model.trim="spiderForm.keyword"></el-input>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" @click="spiderMaterial">采集资源</el-button>
                </el-form-item>
            </el-form>
        ...
        spiderMaterial() {
            this.$refs.spiderForm.validate(valid => {
                if (valid) {
                    bus.$emit('openLog');
                    this.$nextTick(() => {
                        ws.sendMessage({ cmd: 'spiderMaterial', content: this.spiderForm.keyword });
                    })
                } else {
